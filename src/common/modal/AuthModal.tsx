...
import { useAuthorizedUser } from "../../hooks/authorizedUser";
...
export function AuthModal({customFn, useFor, handleOnAuthorized}: AuthProps) {
  const dispatch = useAppDispatch();
  const { authorize, handleOrderingAuthBypass } = useAuthorizedUser();
