    ...
    <>
      ...
      >
        <div className="content">
          ...
          <div className="flex justify-between">
            <p className="font-black text-lg">Less Paid Refunds</p>
            <p className="text-right font-black text-lg">
              {formatNumberWithCommasAndDecimals(
          ...
          <div className="flex justify-between">
            <p className="font-black text-lg">Total VAT Amount</p>
            <p className="text-right font-black text-lg">
              {formatNumberWithCommasAndDecimals(
          ...
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          <p className="font-black text-lg text-center">Discounts</p>
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          ...
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          <p className="font-black text-lg text-center">Card Sales</p>
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
                  ...
                  <>
                    ...
                    <div className="flex flex-col justify-between">
                      {card.cardList.map((item) => {
                        return (
                          <>
                            <p className="font-black text-lg">{item.cardclass}</p>
                            <div className="flex justify-between">
                              <p className="text-right font-black text-lg">
                                {item.qty}
                              </p>
                              <p className="font-black text-lg">
                                {formatNumberWithCommasAndDecimals(item.amount, 2)}
                              </p>
                            </div>
                          </>
                        );
          ...
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          <p className="font-black text-lg text-center">Other MOP Sales</p>
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          ...
          <div className="flex justify-between">
            ...
            <p className="text-right font-black text-lg ml-3">
          ...
          <div className="border-t border-dashed border-black pb-4 mt-4"></div>
          <div className="flex flex-col">
            <p className="font-black text-lg text-center">{dateNowFormatted()}</p>
            <p
              style={{fontSize: "22px"}}
              className="font-black text-lg text-center !important"
            >
