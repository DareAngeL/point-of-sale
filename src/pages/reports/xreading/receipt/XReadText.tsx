...
const XReadText = () => {
  ...
  return (
    <>
      <div id="xread-reciept-text" className="w-full flex font-montserrat">
        <div className="content">
          ...
          <p className=" text-lg font-black">
            {(header.data[0].chknonvat ? "NON-VAT Reg." : "VAT Reg.") +
              ` TIN- ${header.data[0].tin}`}
          </p>
